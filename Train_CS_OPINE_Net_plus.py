...
parser.add_argument('--start_epoch', type=int, default=95, help='epoch number of start training')
...
class BasicBlock(torch.nn.Module):
    def __init__(self):
        ...
        self.net = Uformer(img_size=264,in_chans=1,win_size=6,token_mlp='ffn').cuda()   #token_mlp='ffn','leff'
